...
const { WeaponManager } = require('./weapons/weapon-manager');
const { WeaponDefinition } = require('./weapons/weapon-definition');
...
class PlayerEnricher
{
    ...
    constructor(props)
    {
        ...
        /** @type {WeaponRegistry} */
        this.weaponRegistry = sc.get(props, 'weaponRegistry', false);
        /** @type {boolean} */
    ...
    async withActions(currentPlayer, room)
    {
        ...
        await this.withWeapon(currentPlayer);
    }

    async withWeapon(currentPlayer)
    {
        let weapon = this.weaponRegistry
            ? this.weaponRegistry.getWeapon('default_pistol')
        ...
        currentPlayer.weaponManager = new WeaponManager({
